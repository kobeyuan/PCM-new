...
void GraphNodeCtr::run()
{
	...
	if (singleFrame)//processing single frame  aim to smooth boundary
	{
		...
		//2015-1-1-box
		//read_smooth_label_file("C:\\Users\\kobe\\Desktop\\graphCut\\2015-1-1 box\\label_cor_\\box_labels_smp05_10.00000.txt");//horse-(0-19)-Ë³Ðò¸ã´íÁËµ±Ê±
	...
	//	read_smooth_label_file("C:\\Users\\kobe\\Desktop\\graphCut\\2015-1-3-shiqun-walk\\labels-cor-info\\shiqun_labels_smp10_25.00000.txt");
		...
		read_smooth_label_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hand_leg_cor_labels\\hand_leg_labels_smp20_0.60.txt");
		pca_box_ctr();
...
// 	read_corres_file("corInfo_456.txt");
	...
	//7-8-9 co-segmenationÊ¾ÒâÍ¼--horse
...
// 	read_corres_file("corres(23_24.txt)");
	...
	//read_smooth_label_file("handup_5_15_labels.txt");//µ¥ÊÖ
	//read_corres_file("handup_5_15_corres.txt");

	//ÊÖ½ÅÒ»Æð°Ú¶¯
	//read_label_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\cluster_result\\co-segmentation(15_25)\\labels_15_25.txt");
	//read_corres_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\cluster_result\\co-segmentation(15_25)\\corres_15_25.txt");


	//read_smooth_label_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hand_leg_cor_labels\\co-segmentation(6_7_8)\\labels(6_7_8).txt");
	//read_corres_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hand_leg_cor_labels\\co-segmentation(6_7_8)\\corres(6_7_8).txt");


	//read_smooth_label_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hand_leg_cor_labels\\18_19_20\\labels.txt");
	//read_corres_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hand_leg_cor_labels\\18_19_20\\corres.txt");

	//update 18 frame results
	//read_smooth_label_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hand_leg_cor_labels\\new_18_19_20\\labels.txt");
	//read_corres_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hand_leg_cor_labels\\new_18_19_20\\corres.txt");



	//scanning hands- teaser
	//read_label_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hands\\labels_cor_info\\diff_labels(3_5).txt");
	//read_corres_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hands\\labels_cor_info\\diff_corres(3_5).txt");


	read_label_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hands\\labels_cor_info\\diff_labels(0_7).txt");
	read_corres_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hands\\labels_cor_info\\diff_corres(0_7).txt");

	//read_label_file("C:\\Users\\kobe\\Desktop\\ÂÛÎÄÊµÑéÄÚÈÝ2014-12-30\\hands\\labels_cor_info\\final_labels(01234567).txt");

	IndexType n = cur_graph_index_;

	pca_box_ctr();//¼ÆËã°üÎ§ºÐÐÅÏ¢
 	calculateNorm();//¼ÆËã·¨Ïò
 	////construct boxes distances
 	constructBoxDis(label_bucket);//½¨Á¢°üÎ§ºÐÖ®¼äµÄ¶ÔÓ¦×¼È·ÂÊ
 	...
 	//
 	m_totNode = n;
 	Loggger<<"total nodes number = "<<m_totNode<<endl;
 	//
 	mxArray *mx_distMat = NULL;
 	...
 	//Loggger<<"avg and mid of adjacency"<<avg_a_dis<<" "<<a_mid<<endl;
 	//ScalarType avg_cor_dis,cor_dis;
 	//compute_mid_and_avg(avg_cor_dis,cor_dis,&GraphNodeCtr::dist_between_frame);
 	//Loggger<<"avg and mid of corresponcdence"<<avg_cor_dis<<" "<<cor_dis<<endl;
	...
	/////tranfer to ori poin°Ñ·Ö¸îÐÅÏ¢´«²¥µ½Ô­Ê¼µãÔÆÉÏ
	...
	//for (IndexType i = 0; i < fSize; i++)
	//{
	//	diff_using_bfs(resultLabel[i],vtxId[i],frames[i]);//ÔÚj-linkageÖÐÏàÍ¬¿é·Ö³ö²»Í¬µÄÑÕÉ«³öÀ´
	//}
	
	//ÏÔÊ¾²ÉÑùµã¿ÉÊÓ»¯Ð§¹û--±£´æ×îÖÕµãµÄlabelÐÅÏ¢µ½ÎÄ¼þÖÐ
...
void GraphNodeCtr::pca_box_ctr()
{
	...
	for ( unordered_map<IndexType,set<IndexType>>::iterator iter=label_bucket.begin(); iter!=label_bucket.end();iter++ )
	{
		...
		pbox->vtxSize = k;
		//Loggger<<"boxes"<<boxid++<<endl;
		//Loggger<<"box volume"<<pbox->volume<<endl;
		//Loggger<<"box length"<<pbox->diagLen<<endl;
		//Loggger<<"size"<<members.size()<<endl;
	}
}
...
ScalarType GraphNodeCtr::weight2nodes_dis(GraphCutNode* s_node,GraphCutNode* e_node,ScalarType a_weight)
{
	...
	//Loggger<<"lamda adj = "<<lamda_adj<<endl;
	//Loggger<<"lamda cor = "<<lamda_cor<<endl;
	//Loggger<<" segment number = 5.\n ";
...
ScalarType GraphNodeCtr::weight2nodes(GraphCutNode* s_node,GraphCutNode* e_node,ScalarType a_weight)
{
	...
	}else
	{
		...
		//Loggger<<"a distance = "<<adjDis<<endl;
	}
...
ScalarType GraphNodeCtr::minCorrespondenceDis(GraphCutNode* s_node,GraphCutNode* e_node)
{
	...
	{
		return toDeformable;
		Loggger<<"can't find  inverse correspondence Error!.\n";
	}
...
void GraphNodeCtr::propagateLabel2Orignal(Sample& oriPC,vector<IndexType>& sampleVtxId,vector<IndexType>& label_smp,vector<IndexType>& label_ori)
{
	...
	Loggger<<"The number of segments are "<<nCluster + 1<<endl;
	...
	Loggger<<"k-neig's k = "<<k<<endl;
	Loggger<<"End Propagate!"<<endl;
}
...
// 		Loggger<<"frame = "<<get_frame_from_key(boxKey)<<endl;
// 		Loggger<<"label = "<<get_label_from_key(boxKey)<<endl;
...
{
	Loggger<<"Start calculate normal .\n";
