#ifndef IMAGESHOWWIDGET_H_
#define IMAGESHOWWIDGET_H_
...
public:
	...
	//FOR NEW UI
	enum NewToolMode{TROI = 0, TGLOPTS, BRUSH, APAIR, TANSLATION, BGBRUSH};
...
public:
	...
	//for new ui
	void setToolStatus(bool isSelect, bool isGloAdd,bool isBrush, bool isAddPair, bool isTranslation, bool isbgReplace);
...
signals:
	...
	void meantimeTrans(float&,float&,ImageLabel&);
	void bothZoom(float&,ImageLabel&);
...
private:
	bool m_isSelect;//record if or not draw a rectangle?
	bool m_selectROIs;
	bool m_isBrush;
	bool m_backBrush;
	bool m_foreBrush;
